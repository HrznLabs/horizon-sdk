...
export function randomBytes32(): `0x${string}` {
  ...
  // Optimization: Use 8-bit lookup table. While 16-bit table is faster for standard
  // arrays, the cache line overhead for crypto.getRandomValues buffers degrades performance.
  for (let i = 0; i < 32; i++) {
