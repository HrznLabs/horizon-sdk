...
/**
 * DisputeResolver ABI
 * Manages dispute lifecycle: DDR/LPP deposits, resolution, appeal, and payout
 * Deployed on Base Sepolia: 0xdE37Ff10A487c852941DC842987dd8d5d8b9E855
 */
export const DisputeResolverABI = [
  {
    ...
    inputs: [
      { name: '_usdc', type: 'address' },
      { name: '_resolversDAO', type: 'address' },
      { name: '_protocolDAO', type: 'address' },
      { name: '_protocolTreasury', type: 'address' },
      { name: '_resolverTreasury', type: 'address' },
    ],
    stateMutability: 'nonpayable',
  },
  { type: 'function', name: 'APPEAL_PERIOD', inputs: [], outputs: [{ name: '', type: 'uint256' }], stateMutability: 'view' },
  { type: 'function', name: 'DDR_RATE_BPS', inputs: [], outputs: [{ name: '', type: 'uint256' }], stateMutability: 'view' },
  { type: 'function', name: 'DEFAULT_DDR_TIMEOUT', inputs: [], outputs: [{ name: '', type: 'uint256' }], stateMutability: 'view' },
  { type: 'function', name: 'LPP_RATE_BPS', inputs: [], outputs: [{ name: '', type: 'uint256' }], stateMutability: 'view' },
  { type: 'function', name: 'MAX_DDR_TIMEOUT', inputs: [], outputs: [{ name: '', type: 'uint256' }], stateMutability: 'view' },
  { type: 'function', name: 'MIN_DDR_TIMEOUT', inputs: [], outputs: [{ name: '', type: 'uint256' }], stateMutability: 'view' },
  { type: 'function', name: 'PROTOCOL_FEE_BPS', inputs: [], outputs: [{ name: '', type: 'uint256' }], stateMutability: 'view' },
  { type: 'function', name: 'RESOLVER_FEE_BPS', inputs: [], outputs: [{ name: '', type: 'uint256' }], stateMutability: 'view' },
  { type: 'function', name: 'RESOLVER_TIMEOUT_MULTIPLIER', inputs: [], outputs: [{ name: '', type: 'uint256' }], stateMutability: 'view' },
  {
    type: 'function',
  ...
  { type: 'function', name: 'getAppealPeriod', inputs: [], outputs: [{ name: '', type: 'uint256' }], stateMutability: 'pure' },
  {
    type: 'function',
    name: 'getDDRDeposit',
    inputs: [
  ...
  { type: 'function', name: 'getDDRRate', inputs: [], outputs: [{ name: '', type: 'uint256' }], stateMutability: 'pure' },
  {
    type: 'function',
    name: 'getDispute',
    inputs: [{ name: 'disputeId', type: 'uint256' }],
    outputs: [
      {
        ...
        components: [
          ...
          { name: 'outcome', type: 'uint8' },
          { name: 'resolver', type: 'address' },
          { name: 'ddrAmount', type: 'uint256' },
          { name: 'lppAmount', type: 'uint256' },
          { name: 'posterEvidenceHash', type: 'bytes32' },
          { name: 'performerEvidenceHash', type: 'bytes32' },
  ...
  {
    type: 'function',
    name: 'getDisputesByMission',
    inputs: [{ name: 'missionId', type: 'uint256' }],
    outputs: [{ name: '', type: 'uint256[]' }],
    stateMutability: 'view',
  },
  { type: 'function', name: 'getLPPRate', inputs: [], outputs: [{ name: '', type: 'uint256' }], stateMutability: 'pure' },
  {
    type: 'function',
    name: 'guildDDRTimeout',
    inputs: [{ name: '', type: 'address' }],
    outputs: [{ name: '', type: 'uint256' }],
    stateMutability: 'view',
  },
  ...
  { type: 'function', name: 'protocolDAO', inputs: [], outputs: [{ name: '', type: 'address' }], stateMutability: 'view' },
  ...
  { type: 'function', name: 'resolverTreasury', inputs: [], outputs: [{ name: '', type: 'address' }], stateMutability: 'view' },
  { type: 'function', name: 'resolversDAO', inputs: [], outputs: [{ name: '', type: 'address' }], stateMutability: 'view' },
  {
    type: 'function',
    name: 'setGuildDDRTimeout',
    inputs: [
      { name: 'guild', type: 'address' },
  ...
  },
  {
    type: 'function',
    name: 'setProtocolDAO',
    inputs: [{ name: '_protocolDAO', type: 'address' }],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
    type: 'function',
    name: 'setResolversDAO',
    inputs: [{ name: '_resolversDAO', type: 'address' }],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
  ...
  {
    type: 'event',
    name: 'DDRTimeoutForfeiture',
    inputs: [
      { name: 'disputeId', type: 'uint256', indexed: true },
      { name: 'forfeiter', type: 'address', indexed: true },
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'ddrAmount', type: 'uint256', indexed: false },
    ],
  },
  {
    type: 'event',
    ...
    inputs: [
      ...
      { name: 'posterPayout', type: 'uint256', indexed: false },
      { name: 'performerPayout', type: 'uint256', indexed: false },
  ...
  {
    type: 'event',
    name: 'GuildDDRTimeoutSet',
    inputs: [
      { name: 'guild', type: 'address', indexed: true },
      { name: 'timeout', type: 'uint256', indexed: false },
    ],
  },
  {
    type: 'event',
  ...
  {
    type: 'event',
    name: 'ResolverInactionTimeout',
    inputs: [
      { name: 'disputeId', type: 'uint256', indexed: true },
      { name: 'resolver', type: 'address', indexed: true },
    ],
  },
  { type: 'error', name: 'AppealPeriodActive', inputs: [] },
  { type: 'error', name: 'AppealPeriodEnded', inputs: [] },
  { type: 'error', name: 'DDRDeadlinePassed', inputs: [] },
  { type: 'error', name: 'DisputeNotFound', inputs: [] },
  { type: 'error', name: 'EvidenceAlreadySubmitted', inputs: [] },
  { type: 'error', name: 'InsufficientDDR', inputs: [] },
  { type: 'error', name: 'InvalidDisputeState', inputs: [] },
  { type: 'error', name: 'InvalidOutcome', inputs: [] },
  { type: 'error', name: 'InvalidTimeout', inputs: [] },
  { type: 'error', name: 'NotDAO', inputs: [] },
  ...
  { type: 'error', name: 'ReentrancyGuardReentrantCall', inputs: [] },
  { type: 'error', name: 'ResolverAlreadyAssigned', inputs: [] },
...
/**
 * BuybackExecutor ABI
 * Executes USDC→HRZN buyback-and-burn via Aerodrome; role-gated execution
 * Deployed on Base Sepolia: 0x57Bad3A5871BAEAB2e8aee1D5017Aa272f6564FA
 */
export const BuybackExecutorABI = [
  ...
  { type: 'function', name: 'aerodromeFactory', inputs: [], outputs: [{ name: '', type: 'address' }], stateMutability: 'view' },
  {
    type: 'function',
    name: 'executeBuyback',
    inputs: [
  ...
  { type: 'function', name: 'hrzn', inputs: [], outputs: [{ name: '', type: 'address' }], stateMutability: 'view' },
  {
    type: 'function',
    name: 'renounceRole',
    inputs: [
  ...
  { type: 'function', name: 'totalHrznBurned', inputs: [], outputs: [{ name: '', type: 'uint256' }], stateMutability: 'view' },
  { type: 'function', name: 'totalUsdcSpent', inputs: [], outputs: [{ name: '', type: 'uint256' }], stateMutability: 'view' },
  { type: 'function', name: 'usdc', inputs: [], outputs: [{ name: '', type: 'address' }], stateMutability: 'view' },
  {
    type: 'event',
